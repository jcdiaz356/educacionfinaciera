<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin-SeguiClase.aspx.cs" Inherits="Presentacion.Admin_SeguiClase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#btAceptar').on("click", function () {
            ...
            var getPedido = "";
            getPedido = "&tipo=deleteAconpanaClase&idAconpanaClase=" + id;
            $.ajax({
