<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin-EditEscuela.aspx.cs" Inherits="Presentacion.Admin_EditEscuela" %>
                                                ...
                                                <p>Editar Escuela</p>
                                                   ...
                                                   <%-- <div class="form-group">
                                                    ...
                                                    <%--<div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="NumDocIni" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>--%>
                                                   <%-- <div class="form-group">
                                                        <label for="grado">Nro. Docentes Primaria</label>
                                                        <asp:TextBox ID="NumDocPrim" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>--%>
                                                    <div class="form-group">
                                                    ...
                                                    <%--<div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="NumAlumIni" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>--%>
                                                    <%--<div class="form-group">
                                                        <label for="grado">Nro. Alumnos Primaria</label>
                                                        <asp:TextBox ID="NumAlumPrim" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>--%>
                                                    <div class="form-group">
                                                    ...
                                                    <%--<div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="NumAulas" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>--%>
                                                    <%--<div class="form-group">
                                                        <label for="grado">Nro. Secciones Primaria</label>
                                                        <asp:TextBox ID="NumSeccPrim" runat="server" CssClass="form-control"></asp:TextBox>
                                                    </div>--%>
                                                    <div class="form-group">
