<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin-ListSubDirector.aspx.cs" Inherits="Presentacion.Admin_ListSubDirector" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="cuadro-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                  <a href="Admin-IngSubDirector.aspx?id=5" class="btn btn-default">
                                                    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> NUEVO
                                                </a>

                                            </div>
                                            <div class="col-md-6">
                                                <%-- <asp:LinkButton  ID="btnReport" runat="server" Text=""  class="btn btn-default ">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <table class="table">
                                                    <caption>Listado de SubDirectores.</caption>
                                                    <thead>
                                                    <tr>
                                                        <th>Nº</th>
                                                        <th>Codigo</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <asp:Label ID="FilasListaDocente" runat="server" Text=""></asp:Label>
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script type="text/javascript">
        ...
        $('#btAceptar').on("click", function () {
            ...
            var getPedido = "";
            getPedido = "&tipo=deleteDocente&iduser=" + id;
            $.ajax({
