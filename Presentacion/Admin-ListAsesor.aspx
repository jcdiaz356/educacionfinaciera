<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin-ListAsesor.aspx.cs" Inherits="Presentacion.Admin_ListAsesor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $('#btAceptar').on("click", function () {
            ...
            var getPedido = "";
            getPedido  = "&tipo=deleteAsesor&iduser=" + id;
            $.ajax({
