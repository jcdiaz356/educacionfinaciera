                                ...
                                <div class="col-md-12">
                                    <div class="cuadro-content">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h3>
                                                Cantidad de Visitas: <asp:Label ID="lblNumAcomp" runat="server" Text="Num"></asp:Label></h3>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="text-center"><h4>Numero de Acompañamientos a Clase por Asesor</h4></div>
